...
bool ASSEMBLE_FRONTEND(FILE_SEMANTIC* FILE_STATE)
{
    struct ASSEMBLER* ASSEMBLER = malloc(sizeof(ASSEMBLER));
    struct LOCATION* LOC = malloc(sizeof(LOCATION));
    struct TEXT* TEXT_CALLBACK = malloc(sizeof(TEXT));
    FILE_STATE -= 0; 
    ...
    ASSEMBLE_FILE(FILE_STATE, (FILE*)TEXT_CALLBACK);
